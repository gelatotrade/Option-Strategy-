...
1. **Home**: Overview and quick access to all tools
2. **Strategy Builder**: Build and analyze custom strategies
3. **Optimizer**: Find optimal strategies for your outlook
4. **Options Flow**: Monitor unusual options activity
5. **Greeks Calculator**: Calculate and visualize Greeks
6. **Templates**: Browse and use pre-built strategy templates
7. **Settings**: Configure default parameters
